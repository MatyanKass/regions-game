...
const SUITES := ["res://tests/test_sim.gd", "res://tests/test_bot.gd", "res://tests/test_net.gd", "res://tests/test_players.gd", "res://tests/test_music.gd", "res://tests/test_sfx.gd", "res://tests/test_pace.gd", "res://tests/test_scale.gd", "res://tests/test_save.gd"]
